...
export class ListaProductosComponent {
  ...
  constructor(){
    this.producto = new Producto("Camiseta","https://static.owayo-cdn.com/newhp/img/productHome/productSeitenansicht/productservice/tshirts_classic_herren_basic_productservice/tshirt_basic_4.jpg",180);
    this.productos = [
      new Producto(
        "Nike Air Jordan",
